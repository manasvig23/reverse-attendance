...
//         if (TEST_MODE) {
//             System.out.println("  [TEST] Marked " + status + " for enrollmentId=" + enrollmentId + " on " + date);
//             return;
//         }
...
//         if (TEST_MODE) return 7; // fake: 7 present
...
//         if (TEST_MODE) return 10; // fake: 10 total held
